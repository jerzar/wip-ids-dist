...
export declare class BCFTopics extends Component implements Disposable, Configurable<BCFTopicsConfigManager, BCFTopicsConfig> {
     ...
     */
    export(topics?: Iterable<Topic>, imgBlob?: ArrayBuffer): Promise<Blob>;
...
export declare class IDSSpecifications extends Component {
    ...
    createFacet: {
        attribute: (elements: any[]) => IDSFacet[];
        classification: (elements: any[]) => IDSFacet[];
        entity: (elements: any[]) => IDSFacet[];
        material: (elements: any[]) => IDSFacet[];
        partOf: (elements: any[]) => IDSFacet[];
        property: (elements: any[]) => IDSFacet[];
    };
    /**
...
import { Components } from "../../../../core";
import { IDSFacet } from "../facets";
export declare const createMaterialFacets: (components: Components, elements: any) => IDSFacet[];
import { Components } from "../../../../core/Components";
import { IDSFacet } from "../facets";
...
import { Components } from "../../../../core";
import { IDSFacet } from "../facets";
export declare const createPartOfFacet: (components: Components, elements: any) => IDSFacet[];
import { Components } from "../../../core/Components";
import { Viewpoint } from "../../../core/Viewpoints";
